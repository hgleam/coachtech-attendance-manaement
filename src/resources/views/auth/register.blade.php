    ...
    <div class='register-page__body'>
        ...
        <form method='POST' action='{{ route("register") }}' class='register-form' novalidate>
            ...
            <div class='register-form__group'>
                ...
                <input id='name' type='text' class='register-form__input @error("name") is-invalid @enderror' name='name' value='{{ old("name") }}'>
                @error('name')
            ...
            <div class='register-form__group'>
                ...
                <input id='email' type='email' class='register-form__input @error("email") is-invalid @enderror' name='email' value='{{ old("email") }}'>
                @error('email')
                    <span class='register-form__error' role='alert'>
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class='register-form__group'>
                ...
                <input id='password' type='password' class='register-form__input @error("password") is-invalid @enderror' name='password'>
                @error('password')
                    <span class='register-form__error' role='alert'>
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class='register-form__group'>
                ...
                <input id='password-confirm' type='password' class='register-form__input' name='password_confirmation'>
